...
/** @typedef {import('./components/atmoky/manager'.AtmokyManager)} AtmokyManager */
/**
 * @type {GraphNode[]}
 * @ignore
 */
...
class Entity extends GraphNode {
  ...
  /**
   * Gets the {@link AtmokyManager} attached to this entity.
   *
   * @type {AtmokyManager|undefined}
   * @readonly
   */
  atmokymanager;
   ...
   * - "atmokymanager" - see {@link AtmokyManager}

...
/** @typedef {import('./atmoky/manager.js').AtmokyManagerSystem} AtmokyManagerSystem */
/** @typedef {import('./atmoky/renderer').AtmokyRendererSystem} AtmokyRendererSystem */
/** @typedef {import('./atmoky/source.js').AtmokySourceSystem} AtmokySourceSystem */
...
class ComponentSystemRegistry extends EventHandler {
  ...
  /**
   * Gets the {@link AtmokyManagerSystem} from the registry.
   *
   * @type {AtmokyManagerSystem|undefined}
   * @readonly
   */
  atmokymanager;
  ...
  /**
   * Gets the {@link AtmokySourceSystem} from the registry.
   *
   * @type {AtmokySourceSystem|undefined}
   * @readonly
   */
  atmokysource;
  ...
  add(system) {
    ...
    if (this[id]) {
      throw new Error(
        `ComponentSystem name '${id}' already registered or not allowed`
      );
    }
